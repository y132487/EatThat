...
<div id="content_wrap">
 <div id="content1">
	<section id="submain_section">
		<img src="../images/asiansubmain02.png">
	</section>
 </div>
 ...
 <div id="content2">
	<section id="c_section">
		...
		<article class="c_article" id="c_article2">
		</article>

	</section>
	<aside id="c_aside">
		<img src="../images/edu_title.png">
		<ul>			
			<a href="edu_01.jsp"><li>아시아공동체론 강좌</li></a>
			<a href="edu_02.jsp"><li>J-BIT아카데미</li></a>
			<a href="edu_03.jsp"><li>특별강연</li></a>
		</ul>
	</aside>
 </div>
 </div>
