...
class Client_Multi extends JFrame {
	...
	Client socket = null;
	Client_Lobby c_lobby = null;

	Client_Dog_Thread t_cdog = new Client_Dog_Thread(this);

	public Client_Multi(String IP, String name, String enemyname,
			Client_Lobby c_lobby) {
		this.c_lobby = c_lobby;
		this.myname = name;
		this.enemyname = enemyname;
		setLocation(1, 1);
		setTitle("개밥훔쳐먹기_클라이언트");
	...
	public void toServer(String IP) {
		try {
